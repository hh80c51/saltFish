...
(function(){
    ...
    CONSTANTS.CONTAINER_DEFAULT_KEY = "_front_container";
    /**取完值后需要删除的容器*/
    ...
    /**物业缴费现金黑名单*/
    CONSTANTS.PROPERTY_PAYMENT_NO_CASH = "property_payment_no_cash";
    /**交易所匹配产品查看白名单*/
    CONSTANTS.ACC_BOURSE = "acc_bourse";
    /**默认数据表格的ID*/
    ...
    /** 区分财享+和鸿坤金服标识 **/
    CONSTANTS.ACTION_SCOPE = "action_scope";

    /** 竞拍商品id **/
    CONSTANTS.COMMODITY_ID = "commodity_id";
})();