...
(function(){
    ...
    renderUtil.renderElementById = function(obj){
      if (obj != undefined){
          if (obj instanceof Array){
              for(var i in obj){
                  _doRenderElementById(obj[i]);
              }
          }else {
              _doRenderElementById(obj);
          }
      }  
    };
    
    function _doRenderElementById(obj){
        for (var x in obj){
            $("#" + x).text(obj[x]);
        }
    }
        ...
        for(var x in obj){
            ...
            if($(classNameDefault + "," + className + "," + className1+","+classNameDate+","+classNameTime) != undefined){
                $(classNameDefault + "," + className + "," + className1+","+classNameDate+","+classNameTime).each(function(){
                    var value = obj[x];
                    if((value == 0 || value == '' || value == null || value == undefined || value == 'null')
